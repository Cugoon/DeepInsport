...
from Select_Angle_Image import Select_Angle_Image


class Select_Category(QMainWindow):
    ...
    def init_UI(self):
        ...
        self.next_button.setToolTip("This is an example button")

        """按钮坐标x = 100, y = 70"""
        # self.start_button.move(100,240)
        self.next_button.setGeometry(QRect(100, 240, 120, 28))
        ...
        """按钮与鼠标点击事件相关联"""
        self.next_button.clicked.connect(self.onclick_next)

        self.Pro1_button = QPushButton(self)
        self.Pro1_button.setGeometry(QRect(250, 400, 180, 360))
        self.Pro1_button.setStyleSheet("QPushButton{background-image:url(UI_images/icons/CollinMorikawa.png);}")
        ...
        self.Pro2_button.setStyleSheet("QPushButton{background-image:url(UI_images/icons/DustinJohnson.png);}")
        ...
        self.Pro3_button.setStyleSheet("QPushButton{background-image:url(UI_images/icons/RoryMcIlroy.png);}")
        ...
        self.Pro4_button.setStyleSheet("QPushButton{background-image:url(UI_images/icons/TigerWoods.png);}")
    ...
    def onchick_select_pro1(self):
        ...
        the_window = Select_Angle_Image(video_path, front_image, side_image)
        self.close()
        self.windowList.append(the_window)

    def onchick_select_pro2(self):
        video_path = r"Video/DustinJohnson/"
        front_image = "QPushButton{background-image:url(UI_images/icons/DustinJohnson_front.png);}"
        side_image = "QPushButton{background-image:url(UI_images/icons/DustinJohnson_side.png);}"
        the_window = Select_Angle_Image(video_path, front_image, side_image)
        self.close()
        self.windowList.append(the_window)
    ...
    def onchick_select_pro3(self):
        ...
        side_image = "QPushButton{background-image:url(UI_images/icons/RoryMcIlroy_side.png);}"
        the_window = Select_Angle_Image(video_path, front_image, side_image)
        self.close()
        self.windowList.append(the_window)
